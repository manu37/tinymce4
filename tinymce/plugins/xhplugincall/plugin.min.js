(function () {
    ...
    editor.on('BeforeSetContent',function(e){
      if (e.load) {
        e.content=e.content.replace(/\{{3}(.*?)\}{3}/g,"<span class="xhplugincall mceNonEditable">$1</span>");
      }
    });
    editor.on('GetContent',function(e){
      if (e.save) {
        e.content = e.content.replace(/\<span class="xhplugincall mceNonEditable"\>+?(.*?)\<\/span\>+?/g,$2);
      }
    });
	});
})();
